...
public class BitstreamToneGenerator implements ToneThread.ToneIterator {
    final static int START_HZ = 18000;
    final static int STEP_HZ = 60;
    final static int BITS = 4;

    final static int HANDSHAKE_START_HZ = 19400;
    final static int HANDSHAKE_END_HZ = 19400 + 512;
